...
namespace ServidorHttpSimples
{
    public class ServidorHttp
    {
        ...
        private void CriarHtmlExemplo()
        {
            ...
            html.Append("<meta name=\"viewport\" content=\"width=device-witdh, initial-scale=1.0\">");
        ...
        {
            string diretorio = "C:\\aprendizado\\projectsCS\\DesenvolvimentoWebcomASPNET\\ServidorHttpSimples\\www";
